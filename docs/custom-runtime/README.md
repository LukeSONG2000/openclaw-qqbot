...
- `src/custom/dispatch-failure-gateway-adapter.ts`: gateway-side response-timeout/context-too-long notice and fallback-event orchestration for dispatch race failures.
